...
int main()
{
	...
	// load textures
	// -------------
	unsigned int texture_diffuse1 = loadTexture("brickwall.jpg");
	unsigned int texture_normal1 = loadTexture("brickwall_normal.jpg");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindTexture(GL_TEXTURE_2D, texture_normal1);
		renderQuad();
